	 ...
	 )
{
  ...
  //------------------------------------
  __SV2__ *dst_val = NULL; 
  long long *dst_val_I8 = NULL;
  char      *dst_val_I1 = NULL;
  if ( in_dst_val != NULL ) { 
    dst_val = (__SV2__ *)in_dst_val; dst_val += lb;
    switch ( ijoin_op ) {
    case join_exists : 
    ...
    case join_reg : 
    case join_or : 
      assign_const___SV1__(dst_val, (ub-lb), 0);
      break;
    case join_and : 
      assign_const___SV1__(dst_val, (ub-lb), __SVAND__);
      break;
      /*---------------------------------------------------------*/
    case join_min : 
      assign_const___SV1__(dst_val, (ub-lb), __SVMAX__);
      break;
      /*---------------------------------------------------------*/
    case join_max : 
      assign_const___SV1__(dst_val, (ub-lb), __SVMIN__);
      break;
      /*---------------------------------------------------------*/
    default : 
      go_BYE(-1);
...
// START FUNC DECL
int
core_srt_join___SL1_____SV1_____DL1__(
				      __SL2__ *src_lnk,
				      __SV2__ *src_val,
				      long long src_nR,
				      __DL2__ *dst_lnk,
