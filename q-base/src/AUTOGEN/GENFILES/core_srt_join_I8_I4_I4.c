	 ...
	 )
{
  ...
  if ( in_dst_val != NULL ) { 
    dst_val = (int *)in_dst_val; dst_val += lb;
    switch ( ijoin_op ) {
    case join_exists : 
    ...
    case join_reg : 
    case join_or : 
      assign_const_I4(dst_val, (ub-lb), 0);
      break;
    case join_and : 
      assign_const_I4(dst_val, (ub-lb), 0xFFFFFFFF);
      break;
      /*---------------------------------------------------------*/
    case join_min : 
      assign_const_I4(dst_val, (ub-lb), INT_MAX);
      break;
      /*---------------------------------------------------------*/
    case join_max : 
      assign_const_I4(dst_val, (ub-lb), INT_MIN);
      break;
      /*---------------------------------------------------------*/
    default : 
      go_BYE(-1);
