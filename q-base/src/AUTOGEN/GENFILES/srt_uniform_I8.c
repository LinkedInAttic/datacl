...
#ifdef UNIT_TEST
/*
gcc -g -std=gnu99 -Wall auxil.c mmap.c _x.c ./AUTOGEN/GENFILES/assign_I*.c ./AUTOGEN/GENFILES/qsort_*I8.c -I./AUTOGEN/GENFILES -I. -lm
*/
#include <stdio.h>
#include <sys/mman.h>
#include <stdbool.h>
    ...
    )
{
  ...
  status = srt_uniform_I8((int *)X, nR, (int *)Y, "asc"); cBYE(status);
