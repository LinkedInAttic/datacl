...
// START FUNC DECL
int
xfer___PRXFERTYPE_____PRIDXTYPE__(
				  char *src_fld_X, 
				  char *nn_src_fld_X, 
				  long long src_nR,
				  char *dst_idx_X, 
...
#pragma omp for
  ...
  for ( long long i = lb; i < ub; i++ ) {
    ...
    __IDXTYPE__  *idxptr = (__IDXTYPE__  *) dst_idx_X;
    __XFERTYPE__ *valptr = (__XFERTYPE__ *)src_fld_X;
    __XFERTYPE__ *outptr = (__XFERTYPE__ *)dst_fld_X;
