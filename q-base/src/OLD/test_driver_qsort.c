...
#define ITERS 12*64
  ...
  for ( int iters = 0; iters < ITERS; iters++ ) {
    ...
    switch ( itype ) { 
      ...
      case 3 : 
      case 4 : 
        qsort(Z, N, sizeof(int), sort_asc_int);
	break;
      case 5 : 
        qsort(Z, N, sizeof(int), sort_desc_int);
	break;
      case 6 : 
        qsort(ZLL, N, sizeof(long long), sort_asc_longlong);
	break;
      case 7 : 
        qsort(ZLL, N, sizeof(long long), sort_desc_longlong);
	break;
      case 8 : 
      case 9 : 
        qsort(Z, N, sizeof(int), sort_asc_int);
    ...
    switch ( itype ) { 
      case 0 : 
        qsort_with_idx(i_srt_ordr, Y, N, sizeof(int), sort_asc_int);
	break;
      case 1 : 
        qsort_with_idx_int(i_srt_ordr, Y, N, sizeof(int), sort_asc_int);
	break;
      case 2 : 
        qsort_with_idx_longlong(ll_srt_ordr, Y, N, sizeof(int), sort_asc_int);
	break;
      case 3 : 
        quicksort_int(Y, N, sizeof(int), NULL);
	break;
      case 4 : 
        qsort_asc_int(Y, N, sizeof(int), NULL);
	break;
      case 5 : 
        qsort_dsc_int(Y, N, sizeof(int), NULL);
	break;
      case 6 : 
        qsort_asc_longlong(YLL, N, sizeof(long long), NULL);
	break;
      case 7 : 
        qsort_dsc_longlong(YLL, N, sizeof(long long), NULL);
	break;
      case 8 : 
        qsort_asc_val_int_idx_int(i_srt_ordr, (void *)Y, N, NULL);
	break;
      case 9 : 
        qsort_asc_val_int_idx_longlong(ll_srt_ordr, Y, N, NULL);
	break;
      case 10 : 
        qsort_asc_val_longlong_idx_int(i_srt_ordr, YLL, N, NULL);
	break;
      case 11 : 
        qsort_asc_val_longlong_idx_longlong(ll_srt_ordr, YLL, N, NULL);
	break;
      default : 
	go_BYE(-1);
	break;
